...
import hikingWorldModel from "../datasets/hiking/tg_hikeworldmodel_v2.json" with { type: "json" };
...
export const getPhysiologyAdaptation = (args = {}) => {
  if (!args.module) {
    return {
      ...
      note: "Pass a module slug to return module records. Without a module, this tool returns the active physiology module catalog.",
...
export const DATASET_JSON_BY_SOURCE_PATH = new Map([
  ...
  ["datasets/hiking/tg_hikeworldmodel_v2.json", hikingWorldModel],
