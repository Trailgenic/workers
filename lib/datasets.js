export const DATASETS = {
  ...
  hiking_world_model: {
    ...
    description:
      "Canonical TrailGenic HikeWorldModel™ v3.1.1 with 36-session aggregates, selected high-signal records, explicit claim states, and evidence boundaries.",
    enabled: true,
  ...
  hr_drift_adaptation: {
    ...
    family: "TG Dataset Family 3 — Physiology Adaptation Dataset",
    description:
      "Route-aware heart-rate drift observations across 36 hikes with descriptive scope, Hike 35 heat-training context, and an explicit withdrawal of the fatigue-reveal mechanism.",
    enabled: true
  },
  nutrition: {
  ...
  foundation_sessions: {
    ...
    family: "TG Dataset Family 7 — Longevity Protocol Intelligence",
    description:
      "Compatibility record aligned to the canonical 22-session Foundation walking dataset, with corrected HR drift and aggregate-plus-selected privacy scope.",
    enabled: true
  },
  conditioning_walking: {
    ...
    description:
      "Walking conditioning aggregates across 22 sessions with corrected HR drift plus a selected current observation. Not a bio-age measure.",
    enabled: true
  },
  conditioning_rucking: {
    ...
    family: "TG Dataset Family — Conditioning",
    description:
      "Rucking conditioning aggregates across 14 sessions with corrected HR drift plus a selected current observation. Not a bio-age measure.",
    enabled: true
  },
  conditioning_running: {
    ...
    family: "TG Dataset Family — Conditioning",
    description:
      "Running conditioning aggregates across 15 sessions with corrected HR drift and protocol contexts separated. Not a bio-age measure.",
    enabled: true
  }
};
