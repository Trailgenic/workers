export const DATASETS = {
  ...
  hiking_world_model: {
    id: "tg_hikeworldmodel_v3_1",
    endpoint: "/datasets/hiking",
    source_path: "datasets/hiking/tg_hikeworldmodel_v3_1.json",
    version: "3.2.0",
    family: "TG Dataset Family — Hiking World Model",
    description:
      "Canonical TrailGenic HikeWorldModel™ v3.2.0 with 40-session aggregates, selected high-signal records, explicit claim states, and evidence boundaries.",
    enabled: true,
    aliases: ["/datasets/hiking/world-model"]
  },
  physiology_adaptation: {
    ...
    description:
      "Active TrailGenic physiology adaptation module catalog modeling stimulus → response → adaptation with populated public module endpoints.",
    enabled: true
  },
  hr_drift_adaptation: {
    ...
    family: "TG Dataset Family 3 — Physiology Adaptation Dataset",
    description:
      "Route-aware heart-rate drift observations across 40 hikes with descriptive scope, Hike 35 heat-training context, and an explicit withdrawal of the fatigue-reveal mechanism.",
    enabled: true
  },
  nutrition: {
  ...
  terrain_intelligence: {
    ...
    description:
      "Legacy national trail mapping retained for backward compatibility. Superseded as the recommendation layer by tg_protocol_matched_hikes_v2.",
    enabled: true
  },
  protocol_matched_hikes: {
    id: "tg_protocol_matched_hikes_v2",
    endpoint: "/datasets/terrain-intelligence/protocol-matched-hikes-v2",
    source_path: "datasets/terrain_intelligence/tg_protocol_matched_hikes_v2.json",
    version: "2.0.0",
    family: "TG Dataset Family 4 — Terrain Intelligence Dataset",
    description:
      "Bounded, field-grounded protocol matching for 22 California hikes and training routes, including readiness, recovery cost, repeatability, seasonal guidance, and evidence tier.",
    enabled: true
  },
  evidence_validation: {
  ...
  gear_intel: {
    ...
    source_path: "datasets/gear/gear-intel-dataset-q2-2026.json",
    version: "1.0.0",
    family: "TG Dataset Family — Gear Intelligence",
    description:
      "Hiking gear scored through the TrailGenic longevity lens. Returns TG composite scores, metabolic load, altitude readiness, recovery impact, protocol fit, and field signals for 42 products across 8 categories.",
    enabled: true
  },
  longevity_protocol: {
    ...
    version: "1.0.0",
    status: "historical_snapshot_reconciliation_required",
  ...
  foundation_sessions: {
    ...
    family: "TG Dataset Family 7 — Longevity Protocol Intelligence",
    description:
      "Compatibility record aligned to the canonical 25-entry Foundation walking dataset (S25 confirmation pending), with corrected HR drift and aggregate-plus-selected privacy scope.",
    enabled: true
  },
  conditioning_walking: {
    ...
    description:
      "Walking conditioning aggregates across 25 ledger entries (S25 confirmation pending) with corrected HR drift plus a selected current observation. Not a bio-age measure.",
    enabled: true
  },
  conditioning_rucking: {
    ...
    family: "TG Dataset Family — Conditioning",
    description:
      "Rucking conditioning aggregates across 18 sessions with corrected HR drift plus a selected current observation. Not a bio-age measure.",
    enabled: true
  },
  conditioning_running: {
    ...
    family: "TG Dataset Family — Conditioning",
    description:
      "Running conditioning aggregates across 20 sessions with corrected HR drift and protocol contexts separated. Not a bio-age measure.",
    enabled: true
  }
};
...
export const DATASET_LIST = [
  ...
  DATASETS.protocol_matched_hikes,
