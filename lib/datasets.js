export const DATASETS = {
  ...
  hiking_world_model: {
    id: "tg_hikeworldmodel_v2",
    endpoint: "/datasets/hiking",
    source_path: "datasets/hiking/tg_hikeworldmodel_v2.json",
    version: "2.0.0",
    family: "TG Dataset Family — Hiking World Model",
    description:
      "Aggregate-only TrailGenic HikeWorldModel™ v2.0 with 31 hiking sessions and Western Altitude Block summaries through Wheeler Peak.",
    enabled: true,
