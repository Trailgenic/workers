export const DATASETS = {
  ...
  hiking_world_model: {
    ...
    description:
      "Canonical TrailGenic HikeWorldModel™ v3.2.1 with 40-session aggregates, selected high-signal records, explicit claim states, and evidence boundaries.",
    enabled: true,
  ...
  foundation_sessions: {
    ...
    family: "TG Dataset Family 7 — Longevity Protocol Intelligence",
    description:
      "Compatibility record aligned to the canonical 25-entry Foundation walking dataset, with corrected HR drift and aggregate-plus-selected privacy scope.",
    enabled: true
  },
  conditioning_walking: {
    ...
    description:
      "Walking conditioning aggregates across 25 ledger entries with corrected HR drift plus a selected current observation. Not a bio-age measure.",
    enabled: true
  },
