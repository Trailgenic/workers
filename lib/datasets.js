export const DATASETS = {
  ...
  hiking_world_model: {
    ...
    description:
      "Canonical TrailGenic HikeWorldModel™ v3.1 with 34-session aggregates, selected high-signal records, explicit claim states, and evidence boundaries.",
    enabled: true,
  ...
  hr_drift_adaptation: {
    ...
    family: "TG Dataset Family 3 — Physiology Adaptation Dataset",
    description:
      "Route-aware heart-rate drift observations across 34 hikes with descriptive scope and an explicit withdrawal of the fatigue-reveal mechanism.",
    enabled: true
  },
  nutrition: {
  ...
  conditioning_walking: {
    ...
    description:
      "Walking conditioning aggregates across 21 sessions plus a selected current observation. Not a bio-age measure.",
    enabled: true
  },
  conditioning_rucking: {
    ...
    family: "TG Dataset Family — Conditioning",
    description:
      "Rucking conditioning aggregates across 9 sessions plus a selected current observation. Not a bio-age measure.",
    enabled: true
  },
  conditioning_running: {
    ...
    family: "TG Dataset Family — Conditioning",
    description:
      "Running conditioning aggregates across 15 sessions, with steady-state and max-speed interval tracks separated. Not a bio-age measure.",
    enabled: true
  }
};
