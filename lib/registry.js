...
export const DATA_TOOLS = [
...

  {
    ...
    description:
      "Return the canonical TrailGenic HikeWorldModel™ v3.2.1 dataset: 40-session aggregates, Hike 35 heat-training context, selected high-signal observations, active and withdrawn claims, and explicit n-of-1 evidence boundaries.",
  ...
  },
  {
    ...
    description:
      "Return the aggregate-plus-selected compatibility record aligned to the canonical 25-entry Foundation walking dataset and corrected HR drift.",
