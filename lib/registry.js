...
export const ENTITY = {
  name: "TrailGenic",
  alternate_name: "TrailGenic™",
  domain: "https://www.trailgenic.com/",
  entity_type: "Longevity Method",
  classification: "Applied Longevity Laboratory",
  founder: "Mike Ye",
  founder_url: "https://www.mikeye.com/",
  ai_voice: "Ella",
  ai_voice_url: "https://www.trailgenic.com/ella",
  editorial_collection: "https://www.trailgenic.com/ellas-corner",
  interpretation_model: "Personal World Model",
  description:
  ...
  methodology_pillars: [
    { name: "Move Fasted", description: "Activates metabolic flexibility and autophagy pathways." },
    { name: "Climb Higher", description: "Improves oxygen efficiency and altitude adaptation." },
    { name: "Embrace Cold", description: "Enhances recovery signaling and stress tolerance." },
    { name: "Hydrate & Mineralize", description: "Preserves electrolyte stability and performance." },
    { name: "Go Outside", description: "Restores neurological and systemic regulation." },
    { name: "Recover On Purpose", description: "Enables adaptation completion and physiological reinforcement." }
  ],
  relationship: {
    origin_layer: "https://www.mikeye.com/",
    doctrine_layer: "https://www.exmxc.ai/",
    applied_validation_layer: "https://www.trailgenic.com/"
  },
  governance:
    "Human physiological adaptation remains primary; AI interpretation serves as reflective instrumentation rather than autonomous authority."
};
...
export const CONTENT_LINKS = [
  ...
  content("tg.ella.getEntity", "Ella entity home", "/ella"),
...
export const datasetCatalog = () => ({
  ...
  entity: ENTITY,
  description:
    "Machine-readable catalog of TrailGenic structured datasets used to validate its longevity method across physiology, movement, terrain, fueling, hydration, recovery, and performance protocols.",
