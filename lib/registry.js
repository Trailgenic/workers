...
export const DATA_TOOLS = [
...

  {
    ...
    description:
      "Return the canonical TrailGenic HikeWorldModel™ v3.1 dataset: 34-session aggregates, selected high-signal observations, active and withdrawn claims, and explicit n-of-1 evidence boundaries.",
...

  {
    ...
    description:
      "Return walking conditioning aggregates plus selected scrubbed observations, methodology, and bounded claims across 21 sessions. Not a bio-age measure.",
  ...
  },
  {
    ...
    description:
      "Return rucking conditioning aggregates plus selected scrubbed observations, methodology, and bounded claims across 9 sessions. Not a bio-age measure.",
  ...
  },
  {
    ...
    description:
      "Return running conditioning aggregates plus selected scrubbed observations across 15 sessions, with steady-state and max-speed interval tracks separated. Not a bio-age measure.",
